...
async function mainCmdHandler() {
  ...
  const downloadList = [
    1016923, 1003743, 396947, 432423, 440134, 434166, 426001, 441315, 441103, 440548, 441489,

    1025325, 1025316, 1024145, 1023753, 1022241, 1021792, 1021182, 1019581, 1018783, 1018383, 1017452, 1014943, 1004815,
    440161, 423408, 1004726, 1005103, 1003834, 1000682, 1005630,
